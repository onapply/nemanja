...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="dropdown">
                <button class="btn btn-primary btn-lg dropdown-toggle" type="button" id="onapply1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                    Favourite hero
                </button>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="disabled"><a href="#">Aquaman</a></li>
